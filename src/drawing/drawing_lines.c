...
/*   Updated: 2024/12/01 20:14:38 by dmlasko          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_sloped_line(t_data *data, t_coor pt_1, t_coor pt_2)
{
	...
	while (curr.x_iso < pt_2.x_iso)
	{
		...
		curr.z_clr = get_clr_between_points(data, pt_1, pt_2, distance);
		...
		next.z_clr = get_clr_between_points(data, curr, pt_2, distance);
